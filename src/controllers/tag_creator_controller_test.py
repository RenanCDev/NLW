...
from src.drivers.barcode_handler import BarcodeHandler as bh
from .tag_creator_controller import TagCreatorController as cc

@patch.object(bh, 'create_barcode')
def test_create(mock_create_barcode):
    mock_value = "image_path"
    mock_create_barcode.return_value = mock_value
    tag_creator_controller = cc
